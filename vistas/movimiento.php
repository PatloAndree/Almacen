              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form autocomplete="off" name="formulario" id="formulario" method="POST">
...
<script type="text/javascript" src="../public/plugins/timepicker/bootstrap-timepicker.min.js"></script>
